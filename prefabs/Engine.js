class SchismScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.dialogueRectangle = this.add.rectangle(220, 1035, 1470, 300, 0x000000).setOrigin(0).setDepth(dialogueDepth).setAlpha(0.7);
        this.dialogueRectangle.setScrollFactor(0);
        this.dialogueRectangle.visible = false;
        this.dialogueText = this.add.text(240, 1055, '', {fontSize: 40, color: '#ffffff', wordWrap: { width: 1460 }}).setDepth(dialogueDepth);
